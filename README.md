...
- **sniff-bits-uno** : reads 8bits of data and 8bits of addresses, on a given signal pin. Useful to debug a traditial CPU/EEPROM setup.
- **sniff-bits-mega** : reads 8bits of data and 8bits of addresses, on a given signal pin. Useful to debug a traditial CPU/EEPROM setup.
